  ...
  useEffect(() => {
    const fetchIjazahReject = async () => {
      try {
        ...
        console.error("Gagal mengambil data ijazah reject:", error);
      ...
      if (isEllipsis) {
        return (
          <button
            ...
            type="button"
            disabled={true}
            className="w-8 h-8 flex items-center justify-center rounded text-xs font-bold text-gray-400 cursor-default"
          >
            ...
          </button>
        );
