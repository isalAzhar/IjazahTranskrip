      ...
      batch.mahasiswa.forEach((mhs) => {
        ...
        if (matchNama || matchNim || matchProdi) {
          result.push({
            ...
            mahasiswa: { ...mhs, batch: mhs.batch || batch.batch, fakultas: mhs.fakultas || batch.fakultas, tahun: mhs.tahun || batch.tahun, status: "Proses" },
          });
        }
      });
    });
  ...
  return (
    <DashboardLayout>
      <div className="w-full">
        <div className="mb-6">
          <h1 className="text-[26px] font-bold text-gray-900">Jumlah Ijazah di Proses</h1>
