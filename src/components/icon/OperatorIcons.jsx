// src/icon/OperatorIcons.js

export const OperatorIcons = {
  // ===============================
  // DASHBOARD STATS ICON (OPERATOR)
  // ===============================
  ...
  // Icon Check / Centang — untuk "Ijazah Diproses"
  Check: (
  ...
  // Icon Upload / Import Data — untuk operator upload data mahasiswa
  Upload: (
  ...
  // Icon Edit / Pensil — untuk aksi edit data
  Edit: (
